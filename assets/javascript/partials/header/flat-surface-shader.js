...
/**
 * @see https://github.com/shellthor/flat-surface-shader 
 */
 
/*
var container = document.getElementById('flat-surface-shader');
...
(function(){
  ...
  var outputBefore = document.getElementById('particles-subtext-container');
  ...
  function setRenderer(index) {
    ...
    renderer.setSize(container.offsetWidth, container.offsetHeight);
    output.insertBefore(renderer.element, outputBefore);
  }
